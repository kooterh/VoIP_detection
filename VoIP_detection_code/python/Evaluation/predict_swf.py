...
fbin=mismatch_x.shape[1] #input timesteps
#timesteps=1
nframes=mismatch_x.shape[2]

n_class=mismatch_y.shape[1]
#ntest=test_x.shape[0]

nmismatch=mismatch_x.shape[0]
#nmismatch1=mismatch_x1.shape[0]
