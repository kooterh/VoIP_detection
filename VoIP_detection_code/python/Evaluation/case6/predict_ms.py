...
print("Case 6-1 MS-net Start prediction") 
...
print (" Case 6-1 MS-net predicting:")
...
print (" Case 6-1 MS-net Finished .")


print("Case 6-2 MS-net Start prediction") 
...
print (" Case 6-2 MS-net predicting:")
...
print (" Case 6-2 MS-net Finished .")
print ("Finished .")
