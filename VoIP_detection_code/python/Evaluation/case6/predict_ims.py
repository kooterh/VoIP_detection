...
model_save_path=('/VoIP_detection/VoIP_detection_code/python/Feature_extraction/ims_net')

load_name=mat_load_path+'/train_norm_per_sample_ilogmel.mat'
...
print(x_input.shape)
[pred,pred2]=Inception_myself_fully_conv2(x_input,scope='New_3_3_with_bn_fully_conv2_with_three_pred_for_ilog_mel')
print(pred.shape)
print(pred2.shape)
...
params_load=[v for v in vars if (v.name.startswith('New_3_3_with_bn_fully_conv2_with_three_pred_for_ilog_mel'))]
...
print("Case 6-1 IMS-net Start prediction") 
...
print (" Case 6-1 IMS-net predicting:")
...
print (" Case 6-1 IMS-net Finished .")


print("Case 6-2 IMS-net Start prediction") 
...
print (" Case 6-2 IMS-net predicting:")
...
print (" Case 6-2 IMS-net Finished .")
print ("Finished .")
